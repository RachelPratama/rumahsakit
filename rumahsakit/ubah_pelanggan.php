...
$result = mysqli_query($koneksi, "SELECT * FROM tblpelanggan WHERE idpelanggan='$idpelanggan'");
...
<div class="row no-gutters mt-5">
 ...
 <div class="col-md-10 p-5 pt-2">
    <h1><i class="fas fa-male mr-2"></i> Ubah Data Pelanggan</h1><hr>
 ...
 <div class="form-group col-md-8">
        <label >NAMA PELANGGAN</label>
            <input type="text" name="namapelanggan" class="form-control" id="namapelanggan" value="<?php echo $namapelanggan;?>">
    </div>
 </div>
<div class="form-row">
