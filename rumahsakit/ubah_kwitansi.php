...
$result = mysqli_query($koneksi, "SELECT * FROM tblkwitansi WHERE idkwitansi='$idkwitansi'");
while($user_data = mysqli_fetch_array($result)) {
    $idbarang = $user_data['idbarang'];
    $idpelanggan = $user_data['idpelanggan'];
  ...
  <div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
      ...
      <li class="nav-item">
        ...
        <div class="col-md-10 p-5 pt-2">
            <h1><i class="fas fa-user-graduate mr-2"></i> Ubah Data Kwitansi</h1>
            <hr>
            <form action="update_kwitansi.php" method="post">
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label>ID</label>
                        <input type="text" name="idkwitansi" class="form-control" id="idkwitansi" value="<?php echo $idkwitansi;?>">
                    </div>
                </div>
                <div class="form-row">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="idpelanggan" class="form-control" id="idpelanggan" value="<?php echo $idpelanggan;?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label>TOTAL</label>
                        <input type="text" name="total" class="form-control" id="total" value="<?php echo $total;?>">
                    </div>
                </div>
