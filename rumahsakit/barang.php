...
<div class="row no-gutters mt-5">
  ...
  <div class="col-md-10 p-5 pt-2">
    <h1><i class="fas fa-toolbox mr-2"></i> Daftar Barang</h1><hr>
        <a href="tambah_brg.php" class="btn btn-secondary mb-2"> <i class="fas fa-plus-circle mr-2"></i>TAMBAH DATA BARANG</a>
  ...
  <tr>
    ...
    <td><i class="fas fa-edit bg-success p-2 text-white rounded"></i>
      <a href="ubah_brg.php?idbarang=<?php echo $data['idbarang']; ?>">Edit</a>|
      <i class="fas fa-trash-alt bg-danger p-2 text-white rounded"></i>
      <a href="hapus_brg.php?idbarang=<?php echo $data['idbarang']; ?>">Delete</a></tr></td></tr>
      <?php
  }
  ?>
      <a href="laporanbarang.php" class="btn btn-secondary mb-2"></i>CETAK DATA BARANG</a>
      </table>
  </div>
