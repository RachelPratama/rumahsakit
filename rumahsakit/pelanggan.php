...
<div class="row no-gutters mt-5">
  ...
  <div class="col-md-10 p-5 pt-2">
    <h1><i class="fas fa-male mr-2"></i> Daftar Pelanggan</h1><hr>
        <a href="tambah_pelanggan.php" class="btn btn-secondary mb-2"> <i class="fas fa-plus-circle mr-2"></i>TAMBAH DATA PELANGGAN</a>
    <table class="table table-striped table-bordered">
      <thead>
        ...
        include 'koneksi.php';
  $no = 1;
  $sql = mysqli_query($koneksi,"select * from tblpelanggan");
  ...
  <tr>
    ...
    <td><i class="fas fa-edit bg-success p-2 text-white rounded"></i>
      <a href="ubah_pelanggan.php?idbarang=<?php echo $data['idpelanggan']; ?>">Edit</a>|
      <i class="fas fa-trash-alt bg-danger p-2 text-white rounded"></i>
      <a href="hapus_pelanggan.php?idbarang=<?php echo $data['idpelanggan']; ?>">Delete</a></tr></td></tr>
      <?php
  }
  ?>
      <a href="laporanpelanggan.php" class="btn btn-secondary mb-2"></i>CETAK DATA PELANGGAN</a>
      </table>
  </div>
